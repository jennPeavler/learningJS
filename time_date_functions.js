...
hotelName.textContent = hotel.name.toUpperCase();
roomRate.textContent = '$' + hotel.roomRate.toFixed(2) ;      //Writes variables to document
specialRate.textContent = '$' + hotel.offerPrice();
 ...
 // PART TWO: CALCULATE ANO WRITE OUT THE EXPIRY DETAILS FOR THE OFFER
...
function offerExpires(today)  {
    ...
    monthNames =[ 'January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November', 'December' ];
      // Collect the parts of the date to showon the page
